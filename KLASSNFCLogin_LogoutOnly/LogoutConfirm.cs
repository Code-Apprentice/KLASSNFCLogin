...
{
    [Activity(Label = "LogoutConfirm", Theme = "@android:style/Theme.Black.NoTitleBar.Fullscreen")]
    public class LogoutConfirm : Activity
    {
        public Tag tag = null;
        ...
        protected async override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.LogoutConfirmed);

            SetLabels();

            if(name != null)
                SendForm(tagUid, STATUS.LOGOUT);
            else
            {
                await System.Threading.Tasks.Task.Delay(1000);
                this.Finish();
