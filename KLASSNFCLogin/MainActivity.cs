...
{
    [Activity(Label = "KLASSNFCLogin", MainLauncher = true, Theme = "@android:style/Theme.Black.NoTitleBar.Fullscreen")]
    public class MainActivity : Activity
    {
        ...
        private void StartListeningForNFC()
        {
            ...
            var pendingIntent = PendingIntent.GetActivity(this,
                                                          0, 
                                                          new Intent(this, typeof(Login_Logout)), // start login_logout activity
                                                          0);
